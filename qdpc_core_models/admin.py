...
from .models.notificaiton import Notification
# Raw Material models
...
from .models.rawmaterialGradeAcceptance import RawMaterialGradeAcceptanceTest

# Consumable models
from .models.consumable import Consumable,ConsumableDocument,PreCertification
...
from .models.consumableGradeAcceptance import ConsumableGradeAcceptanceTest
...
from .models.componentGradeAcceptance import ComponentGradeAcceptanceTest

# Product models
from .models.product import Product,Drawing
...
from .models.product_batchlist import ProductBatch

from .models.activity import Activity

from .models.product_acceptence import ProductAcceptanceTest
...
admin.site.register(ProductAcceptanceTest)
...
admin.site.register(RawMaterialGradeAcceptanceTest)


# Consumable models
admin.site.register(Consumable)
admin.site.register(ConsumableDocument)
admin.site.register(PreCertification)
admin.site.register(ConsumableBatch)
admin.site.register(ConsumableAcceptanceTest)
admin.site.register(ConsumableGradeAcceptanceTest)
...
admin.site.register(ComponentGradeAcceptanceTest)
