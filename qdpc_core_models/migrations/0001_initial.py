# Generated by Django 5.1 on 2024-11-27 09:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, choices=[('red', 'Red'), ('green', 'Green'), ('blue', 'Blue')], default='red', max_length=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Center',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('raw_material', models.CharField(max_length=255, unique=True)),
                ('title', models.CharField(max_length=255)),
                ('category', models.CharField(choices=[('DOC/DOCX', '.doc/.docx'), ('PDF', '.pdf'), ('TXT', '.txt'), ('XLS/XLSX', '.xls/.xlsx'), ('CSV', '.csv'), ('PPT/PPTX', '.ppt/.pptx'), ('ODP', '.odp'), ('JPG/JPEG', '.jpg/.jpeg'), ('PNG', '.png'), ('ZIP', '.zip'), ('RAR', '.rar')], default='PDF', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acceptance_test', models.ManyToManyField(related_name='components', to='qdpc_core_models.acceptancetest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity', models.IntegerField(help_text='Validity in years')),
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='component_documents', to='qdpc_core_models.component')),
            ],
        ),
        migrations.CreateModel(
            name='Consumable',
            fields=[
                ...
                ('shelf_life_unit', models.CharField(choices=[('days', 'Days'), ('months', 'Months')], max_length=10)),
                ('user_defined_date', models.DateField()),
                ('acceptance_test', models.ManyToManyField(related_name='consumables', to='qdpc_core_models.acceptancetest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity', models.IntegerField(help_text='Validity in years')),
                ('consumable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumable_documents', to='qdpc_core_models.consumable')),
            ],
        ),
        migrations.CreateModel(
            name='Division',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('divisions', models.ManyToManyField(blank=True, null=True, related_name='users', to='qdpc_core_models.division')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calibration_certificate', models.FileField(blank=True, null=True, upload_to='calibration_certificates/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shelf_life_unit', models.CharField(choices=[('days', 'Days'), ('months', 'Months')], max_length=10)),
                ('user_defined_date', models.DateField()),
                ('acceptance_test', models.ManyToManyField(related_name='raw_materials', to='qdpc_core_models.acceptancetest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_document', models.FileField(blank=True, null=True, upload_to='productfiles/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rm_status', models.CharField(choices=[('Valid', 'Valid'), ('Material Expired', 'Material Expired'), ('Test Certificate Expired', 'Test Certificate Expired')], max_length=50)),
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qdpc_core_models.unit'),
        ),
        migrations.AddField(
            model_name='center',
            name='user_type',
