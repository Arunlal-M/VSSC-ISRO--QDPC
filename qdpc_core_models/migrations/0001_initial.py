    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_codes', models.TextField(blank=True, help_text="Comma-separated page codes or 'ALL'", null=True)),
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='role_meta', to='auth.group')),
            ],
        ),
        migrations.CreateModel(
