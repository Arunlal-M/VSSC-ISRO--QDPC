...
class ComponentDocument(models.Model):
    ...
    component = models.ForeignKey(Component, on_delete=models.CASCADE, related_name='component_documents')
    ...
    document = models.FileField(upload_to='Component/Documents/')
