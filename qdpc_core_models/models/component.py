...
class Component(models.Model):
    ...
    acceptance_test = models.ManyToManyField(AcceptanceTest,blank=True, null=True, related_name='components')
...
class ComponentDocument(models.Model):
    ...
    component = models.CharField(max_length=255,unique=True,null=True,blank=True)
