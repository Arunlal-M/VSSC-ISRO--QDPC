...
class Consumable(models.Model):
    ...
    acceptance_test = models.ManyToManyField(AcceptanceTest, blank=True, null=True, related_name='consumables')
...
class ConsumableDocument(models.Model):
    ...
    consumable = models.CharField(max_length=255,unique=True,null=True,blank=True)
