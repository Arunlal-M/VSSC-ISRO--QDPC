        ...
        try:
            ...
            data = {
                "component": {
                    ...
                    "change_percentage": 0  # Add default value
                },
                "raw_materials": {
            ...
            print(f"Error in DashboardSummaryAPI: {e}")
            return Response({"error": "Failed to fetch summary data"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class ResourceStatusAPI(APIView):
    ...
    def get(self, request):
        try:
            ...
            print(f"Error in ResourceStatusAPI: {e}")
            return Response({"error": "Failed to fetch resource status"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class InventoryTrendsAPI(APIView):
    ...
    def get(self, request):
        try:
            ...
            print(f"Error in InventoryTrendsAPI: {e}")
            return Response({"error": "Failed to fetch trends data"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class InventoryDistributionAPI(APIView):
    ...
    def get(self, request):
        try:
            ...
            print(f"Error in InventoryDistributionAPI: {e}")
            return Response({"error": "Failed to fetch distribution data"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class RecentActivityAPI(APIView):
    ...
    def get(self, request):
        try:
            ...
            print(f"Error in RecentActivityAPI: {e}")
            # Return empty data instead of error to prevent dashboard from hanging
